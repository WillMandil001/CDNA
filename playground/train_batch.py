...
@click.option('--batch_size', type=click.INT, default=3, help='Batch size for training.')
@click.option('--num_iterations', type=click.INT, default=100, help='Number of training iterations. Number of epoch is: num_iterations/batch_size.')  # 1/4 of 1000 dataset sample was 14204
...
def main(learning_rate, gpu, batch_size, num_iterations, data_dir, train_val_split, schedsamp_k, use_state, context_frames, num_masks, validation_interval, save_interval, output_dir,current_version, ):
    ...
    data_generator = BatchDataGenerator(batch_size, logger, data_dir, train_val_split) 
